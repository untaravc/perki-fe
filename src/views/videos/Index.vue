        ...
        <div class="grid gap-2 grid-cols-12">
            <div class="col-span-3">
                <div class="text-center p-3 border rounded-lg font-semibold cursor-pointer"
                    :class="selected === 'day_1_a' ? 'bg-red-900 text-white hover:text-white hover:bg-red-800' : 'hover:bg-red-200'"
            ...
            <div class="col-span-3">
                <div class="text-center p-3 border rounded-lg font-semibold cursor-pointer"
                    :class="selected === 'day_1_b' ? 'bg-red-900 text-white hover:text-white hover:bg-red-800' : 'hover:bg-red-200'"
            ...
            <div class="col-span-3">
                <div class="col-span-3">
                    <div class="text-center p-3 border rounded-lg font-semibold cursor-pointer"
                        :class="selected === 'day_2_a' ? 'bg-red-900 text-white hover:text-white hover:bg-red-800' : 'hover:bg-red-200'"
            ...
            <div class="col-span-3">
                <div class="col-span-3">
                    <div class="text-center p-3 border rounded-lg font-semibold cursor-pointer"
                        :class="selected === 'day_2_b' ? 'bg-red-900 text-white hover:text-white hover:bg-red-800' : 'hover:bg-red-200'"
            ...
            <div class="col-span-12 md:col-span-4">
                <div v-for="data in data_detail" @click="detail_selected = data.slug"
                    ...
                    <div class="text-sm font-semibold p-3 bg-red-200">{{ data.title }}</div>
                    <div class="border-t" :class="detail_selected !== data.slug ? 'hidden' : ''">
                        <div class="text-sm py-2 px-3 hover:text-red-700 cursor-pointer" @click="loadVideo(detail)"
            ...
            <div class="col-span-12 md:col-span-8">
                <div v-if="video_active.link" class="bg-red-200 rounded p-4">
                    Unduh Materi
                    <div>
                        <a :href="video_active.link" class="text-red-600 underline" target="_blank">{{
                            video_active.link }}</a>
                    </div>
                </div>
