            ...
            <div class="grid gap-4 md:grid-cols-3 col-span-2">
                <div class="col-span-2">
                    <div v-if="data_raw.symposium"
                        class="rounded-lg bg-amber-200 p-4 border cursor-pointer hover:bg-red-100 mb-3">
                        <div class="mb-3">
                    ...
                    <div class="px-3 py-4 border rounded-lg">
                        ...
                        <div class="mt-5">
                            <button @click="toPayment" :disabled="disabled"
                                class="text-white w-full mb-2 bg-amber-900 hover:bg-red-800 font-medium rounded-full text-base px-8 py-2.5 text-center">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="text-right">
                            ...
                            <a href="http://satusehat.kemkes.go.id/sdmk/register" target="_blank"
                                class="text-white bg-amber-900 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-full text-base px-6 py-1.5 text-center mx-1 my-2 md:mr-0">
                                Create Account
                            </a>
                            <button @click="confirm_modal.hide()"
                                class="text-white bg-amber-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-amber-200 rounded-full text-base px-6 py-1.5 text-center mx-1 my-2 md:mr-0">
                                I have an Account
                            </button>
                        </div>
                    </div>
