        ...
        <div class="p-6 border-rose-100 bg-white rounded-xl">
            <div class="grid gap-4 md:grid-cols-3">
                <div class="">
                    ...
                    <div class="rounded-tl-lg rounded-tr-lg bg-rose-50 p-4 border cursor-pointer hover:bg-rose-100"
                        ...
                        <div class="flex justify-between items-center">
                            <div class="text-sm font-semibold text-rose-700 text-right">
                    ...
                    <div v-for="half_day in events.half_day" @click="selectHalfDay(half_day.id, events.symposium.id)"
                        class="bg-rose-50 p-4 border last:rounded-bl-lg last:rounded-br-lg cursor-pointer hover:bg-rose-100 ">
                        <div class="mb-3">
                            <div class="font-semibold text-rose-900 flex">
                ...
                <div class="">
                    ...
                    <div v-for="full_day in events.full_day" @click="selectFullDay(full_day.id)"
                        class="rounded-lg bg-rose-50 p-4 border cursor-pointer hover:bg-rose-100 mb-3">
                        <div class="mb-3">
                            <div class="font-semibold text-rose-900 flex">
                                {{ full_day.name }}
                            </div>
                ...
                <div class="">
                    ...
                    <div class="px-3 py-4 border rounded-lg">
                        ...
                        <div class="text-sm" v-if="pricing.count === 0">
                            ...
                            <div class="flex justify-between border-t border-rose-800 font-semibold">
                                <div>Total</div>
                                <div>0</div>
                            </div>
                        </div>
