            ...
            <div class="grid gap-4 md:grid-cols-3 col-span-2">
                <div class="col-span-2">
                    <div v-if="data_raw.symposium" @click="selectSympo()"
                        :class="form.symposium ? 'bg-red-200' : 'bg-background-lightRed'"
                        class="rounded-lg p-4 border cursor-pointer hover:bg-red-100 mb-3">
                        <div class="mb-3">
                    ...
                    <div class="col-span-1 grid gap-2 md:grid-cols-1" v-if="data_raw.workshop && count < 1">
                        ...
                        <div v-for="first in events.workshop" @click="selectWorkshop(first.id, first)"
                            :class="form.workshop === first.id ? 'bg-red-200' : 'bg-background-lightRed'"
...
export default {
    ...
    methods: {
        loadData() {
            this.authGet('pub/events-list-jfu25', {
        ...
        calculatePrice(mode = 'calculate') {
            this.authPost('pub/calculate-price-jfu25', {
                items: this.form,
        ...
        selectSympo() {
            this.form.symposium === this.events.symposium['id'] ? this.form.symposium = null : this.form.symposium = this.events.symposium['id']
            this.calculatePrice()
        },
        memberModal() {
        ...
        toPayment() {
            ...
            this.disabled = true;
            this.authPost('pub/create-payment-jfu25', {
                items: {
