            ...
            <div class="p-6 border-red-100 bg-white rounded-xl">
                ...
                <form>
                        ...
                        <div>
                            ...
                            <div class="text-xs p-1 bg-yellow-50 mt-1">
                                <ul class="list-disc ml-4">
                                    ...
                                    <li>For Participants who are not willing to fill in the NIK column, they cannot
                                        learn
                                        and cannot get SKP</li>
                                    <li>The storage an management of NIK data are fully the responsibility of the
                                        Ministry
                                        of Health</li>
                                </ul>
                            </div>
                    ...
                    <div class="grid gap-2 sm:grid-cols-2 mt-3">
                        ...
                        <div>
                            <label for="institution" class="block mb-2 text-sm font-medium text-gray-900">Institution
                                <span class="text-red-600">*</span></label>
                    ...
                    <div class="mt-3">
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900">Phone (Whatsapp
                    ...
                    <div class="mt-3">
                        ...
                        <div class="text-xs bg-yellow-50 mt-1 p-2">
                            Please use the same email as the one registered to your Plataran Sehat account. Don't have
                            one?
                            <a target="_blank" class="font-semibold text-red-700 hover:text-red-600"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input :type="eye_icon ? 'text' : 'password'" id="password" v-model="form.password"
                                    ...
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-900 focus:border-red-500 block w-full p-2.5">
                                <button type="button"
                                    class="p-2 show-password absolute top-1/2 right-2 -translate-y-1/2"
