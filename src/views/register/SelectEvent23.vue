        ...
        <div class="p-6 border-red-100 bg-white rounded-xl">
            <div class="mb-4 grid grid-cols-3 gap-4">
                <div @click="selectPackage('platinum')"
                    ...
                    class="bg-red-800 p-4 rounded-lg flex justify-between items-center cursor-pointer">
                ...
                <div @click="selectPackage('gold')"
                    ...
                    <unicon v-if="package === 'gold'" name="check-square" width="30" height="30"></unicon>
                    <unicon v-else name="square" width="30" height="30"></unicon>
                </div>
                <div @click="selectPackage('add-on')" v-if="data_raw.has_symposium"
                    class="border border-red-800 p-4 rounded-lg flex justify-between items-center cursor-pointer">
                    <div class="font-bold text-red-800">Silver</div>
            ...
            <div class="grid gap-4 md:grid-cols-3 col-span-2">
                <div class="col-span-2">
                    <div v-if="data_raw.symposium"
                        class="rounded-lg bg-red-200 p-4 border cursor-pointer hover:bg-red-100 mb-3">
                        <div class="mb-3">
                    ...
                    <div class="col-span-2 grid gap-2 md:grid-cols-2" v-if="data_raw.workshop">
                        <div>
                            <div v-for="morning in events.morning_workshop" @click="selectMorning(morning.id, morning)"
                                :class="form.morning_workshop === morning.id ? 'bg-red-200' : 'bg-red-50'"
                                class="p-4 border first:rounded-t-lg last:rounded-bl-lg last:rounded-br-lg cursor-pointer hover:bg-red-200 ">
                                <div class="mb-3">
                        ...
                        <div>
                            <div v-for="afternoon in events.afternoon_workshop"
                                ...
                                :class="form.afternoon_workshop === afternoon.id ? 'bg-red-200' : 'bg-red-50'"
                                class="p-4 border first:rounded-t-lg last:rounded-bl-lg last:rounded-br-lg cursor-pointer hover:bg-red-200 ">
                                <div class="mb-3">
