    ...
    <div>
        ...
        <div class="border-red-200 border bg-white rounded mb-2" v-for="trx in data_content">
            ...
            <div class="p-5 flex justify-between">
                <div>
                    <div class="font-semibold cursor-pointer underline text-red-700 hover:text-red-800">
                    ...
                    <div class="ml-4 mb-3">
                        <ul class="list-disc" v-if="trx.transaction_details">
                            <li class="text-sm" v-for="detail in trx.transaction_details">
                                {{ detail.event_name }}
                                <span class="italic text-red-500" v-if="detail.event">{{
                ...
                <div>
                    <div class="font-semibold text-red-700 text-right">
