<template>
    <div>
        ...
        <div class="p-6 border-red-100 bg-white rounded-xl mb-4">
            <div class="grid gap-2 grid-cols-5">
                <div>
                    ...
                    <div class="text-center">
                        <label for="photo-profile" class="text-center text-sm cursor-pointer text-red-800">
                ...
                <div class="col-span-4 pl-4">
                    ...
                    <div class="text-right">
                        <a href="#edit-form"
                            class="text-white bg-red-800 hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 rounded-full text-sm px-8 py-1.5 text-center mr-3 md:mr-0"
        ...
        <div class="p-6 border-red-100 bg-white rounded-xl" id="edit-form" v-if="edit_mode">
            <div class="mb-3">
