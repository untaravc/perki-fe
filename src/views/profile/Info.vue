<template>
    <div>
            ...
            <div class="grid gap-2 grid-cols-5">
                ...
                <div class="col-span-4 pl-4">
                    <div class="flex justify-between">
                        ...
                        <a href="#edit-form" class="text-blue-700 cursor-pointer" @click="editForm(profile)">Edit</a>
                    </div>
        ...
        <div class="p-6 border-slate-100 bg-white rounded-xl" id="edit-form" v-if="edit_mode">
            ...
            <div class="mb-3">
                <label for="address" class="block mb-2 text-sm font-medium text-gray-900">City<span
                    class="text-red-600">*</span></label>
                <input type="text" id="address" autofocus v-model="form.city"
                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-900 focus:border-blue-500 block w-full p-2.5">
