<template>
    <div>
        ...
        <div class="bg-white shadow-sm p-6 rounded-lg mb-4" v-if="open_form">
            ...
            <div class="relative border border-rose-500 rounded-lg p-2">
                ...
                <div class="flex justify-between">
                    ...
                    <label for="file-upload" class="cursor-pointer bg-rose-800 text-white py-1 px-3 rounded-lg">Select
                        File</label>
                </div>
            </div>
        ...
        <!--       List-->
        <div class="border-rose-200 border bg-white rounded mb-2" v-for="data in data_content">
                ...
                <div class="flex justify-between">
                    <div>
                        ...
                        <span v-if="data.category === 'case_report'"
                            class="px-2 py-1 font-semibold bg-rose-200 rounded text-xs">{{ data.category }}</span>
                    </div>
                    <div>
