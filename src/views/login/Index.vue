            ...
            <div class="p-6 border-violet-100 bg-white rounded-xl">
                ...
                <div class="mt-3">
                    <button @click="login" :disabled="disabled"
                        class="text-white mb-2 w-full bg-violet-900 hover:bg-violet-800 font-medium rounded-full text-base px-8 py-2.5 text-center">
                        <BtnLoader v-if="disabled"></BtnLoader>
                        <span v-if="!disabled">Sign In</span>
                    </button>
                </div>
                <!-- <div class="mt-3 text-center">
                    <div class="italic text-violet-500 text-sm mb-2">Sign in with Google</div>
                    <div>
                        <GoogleLogin :callback="loginByGoogle" />
                    </div>
                </div> -->
                <div class="mt-3">
                    <router-link to="/forgot-password" class="text-violet-500 font-semibold text-sm mb-2">Forgot your
