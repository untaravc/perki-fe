    ...
    <div class="max-w-screen-lg m-auto pt-4 px-2" id="schedule">
        ...
        <div class="grid grid-cols-2">
            <div @click="selected = 1" :class="selected === 1 ? 'bg-red-400 text-white' : 'bg-red-100'"
                class="py-3 text-center rounded-tl-lg cursor-pointer hover:bg-red-500 group transition duration-200">
            ...
            <div @click="selected = 2" :class="selected === 2 ? 'bg-red-400 text-white ' : 'bg-red-100'"
                class="py-3 text-center rounded-tr-lg cursor-pointer hover:bg-red-500 group transition duration-200">
                <div class="text-2xl font-bold inline-block">
                    FRIDAY
        ...
        <div v-if="selected === 1" class="p-2 border-b border-red-900">
            ...
            <div class="grid grid-cols-2 gap-2 md:grid-cols-7 mb-4 border-b border-red-300"
                ...
                <div class="col-span-2 text-center md:col-span-1">
                    <div class="inline-block bg-red-100 px-2 py-1 rounded">
        ...
        <div v-if="selected === 2" class="p-2 border-b border-red-900">
            ...
            <div class="grid grid-cols-7">
                ...
                <div class="col-span-7 md:col-span-6 mb-4 border-b border-red-300" v-for="ws_hd in schedule.workshop">
                    <div class="grid grid-cols-4">
                        <div class="col-span-3">
                            <div class="text-red-700 font-bold">{{ ws_hd.name }}</div>
                            <div class="text-base font-semibold">
                                {{ ws_hd.title }}
                            </div>
                            <div class="text-sm my-2 pl-6">
