<template>
    <div class="max-w-screen-lg m-auto pt-4 px-2" id="schedule">
        ...
        <div class="grid grid-cols-2">
            <div @click="selected = 1" :class="selected === 1 ? 'bg-teal-400 text-white' : 'bg-teal-100'"
                class="py-3 text-center rounded-tl-lg cursor-pointer hover:bg-teal-500 group transition duration-200">
            ...
            <div @click="selected = 2" :class="selected === 2 ? 'bg-teal-400 text-white ' : 'bg-teal-100'"
                class="py-3 text-center rounded-tr-lg cursor-pointer hover:bg-teal-500 group transition duration-200">
                <div class="text-2xl font-bold inline-block">
                    FRIDAY
        ...
        <div v-if="selected === 1" class="p-2 border-b border-slate-900">
            ...
            <div class="grid grid-cols-2 gap-2 md:grid-cols-7 mb-4 border-b border-slate-300"
                ...
                <div class="col-span-2 text-center md:col-span-1">
                    <div class="inline-block bg-teal-100 px-2 py-1 rounded">
                ...
                <div class="col-span-2 md:col-span-6">
                    <div v-if="thursday.room_a">
                        <div class="text-teal-700 font-bold">
                            {{ thursday.room_a.name }}
                        </div>
                        <div class="text-base font-semibold">
                            {{ thursday.room_a.title }}
                        </div>
                        <div class="text-sm my-2 pl-6">
                            <ul class="list-disc">
                                <li v-for="item in thursday.room_a.schedule_details">
                                    {{ item.title }}
                        ...
                        <div>
                            <div class="text-center hover:bg-slate-100 cursor-pointer"
                                ...
                                <unicon name="angle-up" height="25px" v-if="thursday.room_a.show"></unicon>
                            </div>
                            <a target="_blank" :href="base_url + thursday.room_a.image"
                                v-if="thursday.room_a.show && thursday.room_a.image">
                                <img class="w-full" :src="base_url + thursday.room_a.image" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-span-7 md:col-span-6 mb-4 border-b border-slate-300" v-for="ws_hd in schedule.workshop">
                    <div class="grid grid-cols-4">
                        <div class="col-span-3">
                            <div class="text-teal-700 font-bold">{{ ws_hd.name }}</div>
                            <div class="text-base font-semibold">
                                {{ ws_hd.title }}
                            </div>
                            <div class="text-sm my-2 pl-6">
