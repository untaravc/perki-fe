    ...
    <div class="max-w-screen-lg m-auto pt-4 px-2" id="schedule">
        ...
        <div class="grid grid-cols-3 mb-4">
            ...
            <div @click="selected = 2"
                :class="selected === 2 ? 'from-red-400 to-purple-400' : 'from-purple-800 to-red-800'"
                class="text-white py-3 text-center cursor-pointer hover:bg-red-600 bg-gradient-to-r group transition duration-200">
                <div class="text-2xl font-bold inline-block">
                    SATURDAY
            ...
            <div @click="selected = 3"
                :class="selected === 3 ? 'from-red-400 to-purple-400' : 'from-purple-800 to-red-800'"
