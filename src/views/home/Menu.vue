<template>
    <div class="max-w-screen-lg m-auto grid grid-cols-6 gap-2 md:grid-cols-5 mt-16 mb-8 px-4">
        <div class="flex justify-center col-span-2 md:col-span-1 shadow-sm p-2 rounded-lg bg-white">
            <a href="#schedule">
        ...
        <div class="flex justify-center col-span-3 md:col-span-1 shadow-sm p-2 rounded-lg bg-white">
            <a href="#venue">
                <div class="flex justify-center mx-auto items-center w-16 h-16 rounded-full mb-2 bg-blue-100">
