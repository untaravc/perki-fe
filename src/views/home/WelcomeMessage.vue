    ...
    <div class="max-w-screen-md m-auto py-6 shadow-md bg-white rounded-lg p-6 md:p-10">
      ...
      <div>
        ...
        <div class="mb-3">
          ...
          International and national CVD prevention experts will gather together delivering us the topic related to CVD
          prevention, CVD epidemiology and Longevity. Not only symposium, CARVEP2025 also bring the Workshops related to
          CVD prevention, namely Cardiopulmonary Exercise Test (CPET) and Ambulatory Blood Pressure Measurements (ABPM)
          workshops
        </div>
        <div class="mb-3">
