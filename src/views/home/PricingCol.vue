    ...
    <div class="max-w-screen-lg m-auto pt-12 pb-12 px-2" id="package">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div v-for="(data, idx) in pricing" class="col-span-3 md:col-span-1 to-gray-300 rounded-lg p-6"
                :class="idx === 0 ? 'bg-red-50' : idx === 1 ? 'bg-red-200' : 'bg-red-100'">
                ...
                <div class="mt-4 mb-4">
                    <router-link to="/register"
                        class="block border-2 border-red-400 hover:bg-red-400 focus:ring-2 focus:outline-none focus:ring-red-400 font-normal md:font-medium rounded-md text-sm md:text-base px-4 md:px-8 py-1 md:py-2.5 text-center">
                        Register
                    </router-link>
                </div>
