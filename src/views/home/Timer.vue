<template>
    <div class="px-2 mb-3">
        <div class="max-w-screen-lg m-auto py-6 bg-background-mint rounded-lg">
            <div class="grid grid-cols-3">
                <div class="col-span-3 md:col-span-1 text-center md:border-r-2 mb-4 border-blue-900">
                    ...
                    <a href="https://maps.app.goo.gl/SHfPxDQp8TMdxZwP7" target="_blank"
                        class="text-sm text-slate-500 underline cursor-pointer">Pascasarjana Tahir Foundation, Jl.
                        Kesehatan No.1,
                        Yogyakarta</a>
                </div>
...
export default {
    ...
    methods: {
        countdown() {
            const countDownDate = new Date("2025-05-29 08:00:00").getTime();
