<template>
    <div class="max-w-screen-lg m-auto pt-12 pb-12 px-2 mt-20" style="min-height: calc(100vh - 84px - 128px)">
        ...
        <div v-if="!has_token" class="rounded-xl shadow-sm bg-yellow-200 p-6 mb-4">
            <div>Please
                <router-link class="text-red-800 font-semibold italic" to="/login">Login</router-link>
                or
                <router-link class="text-red-800 font-semibold italic" to="/register">Register</router-link>
                before submit abstract
            </div>
        </div>
        <div class="rounded-xl shadow-sm bg-red-100 p-6 mb-4">
