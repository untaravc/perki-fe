<template>
    <div class="max-w-screen-lg m-auto pt-24 pb-12 px-2">
        ...
        <div class="text-small text-red-700 mb-5 text-center">
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-8">
            <div class="group" v-for="data in data_content">
                ...
                <div>
                    <h4 class="font-bold text-base text-red-700">{{ data.name }}</h4>
                    <div class="text-xs text-neutral-material-700 text-red-600">{{ data.desc }}</div>
                </div>
            </div>
        </div>
    </div>
