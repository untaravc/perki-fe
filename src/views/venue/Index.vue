<template>
    <div class="max-w-screen-lg m-auto pt-12 pb-12 px-2 mt-20" id="venue">
        ...
        <div class="rounded-xl shadow-sm bg-red-100 grid grid-cols-12 mb-6">
            <div class="col-span-12 md:col-span-5 min-h-[300px]  bg-red-300 rounded-t-xl md:rounded-tr-none md:rounded-l-xl bg-center bg-cover bg-no-repeat">
            </div>
            <div class="col-span-12 md:col-span-7 md:rounded-r-xl p-6">
                <div class="mb-4">
                    <div class="text-2xl font-bold">Get Special Room Prices </div>
                    <div class="italic text-red-800 text-sm">for Participants</div>
                </div>
                <div class="ml-8 mb-4">
                    <ol class="list-decimal">
                        <li>
                            <router-link to="/register"
                                class="font-semibold underline text-red-700">Register</router-link>
                        ...
                        <li>
                            ...
                            <a href="https://goo.gl/maps/4LjYCwk7Ny3v4bh88" target="_blank"
                                class="underline text-red-700 italic">Tentrem Hotel</a>
                            rooms
                        </li>
                    </ol>
                </div>
                <div class="mb-4">
                    ...
                    <a href="https://wa.me/6285865064280?text=Bagaimana cara mendapatkan harga Room khusus peserta?"
                        target="_blank" class="italic text-red-700">https://wa.me/6285865064280</a>
                </div>
            </div>
        </div>

        <div class="rounded-xl shadow-sm bg-red-100 p-6">
            ...
            <div class="">
                ...
                <ul class="list-disc ml-4">
                    <li>Inclusive of twenty one percent (21%) service charge and prevailing government taxes</li>
                    <li>Buffet breakfast at Kayumanis Cofee Shop for two (2) adults</li>
                    <li>Complimentary Internet</li>
                    <li>Welcome amenities</li>
                    <li>Complimentary Minibar</li>
                    <li>Drop Off to Malioboro with priror arrangement (Subject to availability)</li>
                    <li>Sport & Recreation facilities of swimming poll, Fitness Center, Tennis Court, and Kids
                        Playground</li>
                </ul>
            </div>
        </div>
